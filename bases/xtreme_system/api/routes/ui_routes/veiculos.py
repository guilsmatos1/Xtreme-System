...
register_crud_ui_routes(
    ...
    sql_sort_fields={
        ...
        "km": veiculo.Veiculo.km,
        "preco": veiculo.Veiculo.preco,
        "status": veiculo.Veiculo.status,
        "tipo_entrada": veiculo.Veiculo.tipo_entrada,
        "revisao": veiculo.Veiculo.revisao,
        "investidor": investidor.Investidor.nome,
        "procuracao": veiculo.Veiculo.procuracao,
        "tempo_estoque": veiculo.Veiculo.criado_em,
    },
