...
```bash
python3 .claude/skills/0002-send-to-linear/send_improvements.py "<projeto>" <caminho-do-json>
```
...
```bash
python3 .claude/skills/0002-send-to-linear/send_improvements.py "Xtreme System" .loop/running/improvements.json
```
