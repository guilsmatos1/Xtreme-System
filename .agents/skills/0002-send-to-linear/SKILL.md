...
```bash
python3 .agents/skills/0002-send-to-linear/send_improvements.py "<project>" <path-json>
```
...
```bash
python3 .agents/skills/0002-send-to-linear/send_improvements.py "Xtreme System" /absolute/path/to/other-batch.json
```
