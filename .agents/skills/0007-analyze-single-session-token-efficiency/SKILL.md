---
name: 0007-analyze-single-session-token-efficiency
description: Analyzes exactly one Codex worker rollout and writes its canonical token-efficiency report. Use only for isolated jobs dispatched by 0003-analyze-token-efficiency through Orca.
---
...
2. Extract the compact profile once:
   ...
   python3 .agents/skills/0003-analyze-token-efficiency/profile_session.py \
