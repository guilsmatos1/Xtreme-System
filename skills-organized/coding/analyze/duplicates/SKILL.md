...
8. After preparing the final report, save the content to `.loop/running/improvements-duplicates.md` as Markdown.
...
- Write the final report to `.loop/running/improvements-duplicates.md`.
