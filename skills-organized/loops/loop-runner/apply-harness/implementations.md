...
Record of what skill `loops--loop-runner--apply-harness` actually applied to the Codex worker harness. Each block corresponds to an improvement removed from the ranking in `issues-harness.md`.
...
- **Source:** issues-harness.md #4 (10 mentions)
...
- **Source:** issues-harness.md #3 (10 mentions)
...
- **Source:** issues-harness.md #2 (11 mentions)
...
- **Source:** issues-harness.md #1 (13 mentions)
...
- **Source:** issues-harness.md #1 (16 mentions)
...
- **Source:** issues-harness.md #1 (6 mentions)
...
- **Source:** issues-harness.md #2 (5 mentions)
...
- **Source:** issues-harness.md #3 (5 mentions)
...
- **Source:** issues-harness.md #5 (4 mentions)

### Lean devops--deploy--commit-merge / fast path — 2026-07-24
- **Risk level:** medium
- **Changed files:** `skills-organized/devops/deploy/devops--deploy--commit-merge/SKILL.md`
...
- **How to verify:** the `devops--deploy--commit-merge` `SKILL.md` has "## Fast path (check first)" before "## Triggers"; Triggers/Flow sections are intact.
- **How to revert:** remove "## Fast path (check first)" from `devops--deploy--commit-merge/SKILL.md`.
- **Source:** issues-harness.md #4 (4 mentions)
