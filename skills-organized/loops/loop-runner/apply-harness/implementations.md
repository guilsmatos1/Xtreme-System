...
Record of what skill `loops--loop-runner--apply-harness` actually applied to the Codex worker harness. Each block corresponds to an improvement removed from the ranking in `improvements-harness.md`.
